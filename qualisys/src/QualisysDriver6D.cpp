#include <qualisys/QualisysDriver6D.h>
#include <algorithm>
...
double QualisysDriver6D::deg2rad = M_PI / 180.0;

QualisysDriver6D::QualisysDriver6D(const ros::NodeHandle& n):
  nh(n),
  publish_tf(false){
  return;
}

bool QualisysDriver6D::init() {
...
void QualisysDriver6D::disconnect() {
...
void QualisysDriver6D::checkPublishers(const int& body_count) {
...
void QualisysDriver6D::handlePacketData(CRTPacket* prt_packet) {
